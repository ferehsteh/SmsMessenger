...
public class MessageSelection extends AbstractSelection<MessageSelection> {
    ...
    public MessageSelection date(Integer... value) {
        addEquals(MessageColumns.DATE, value);
        return this;
    }

    public MessageSelection dateNot(Integer... value) {
        addNotEquals(MessageColumns.DATE, value);
        return this;
    }

    public MessageSelection dateGt(int value) {
        addGreaterThan(MessageColumns.DATE, value);
        return this;
    }

    public MessageSelection dateGtEq(int value) {
        addGreaterThanOrEquals(MessageColumns.DATE, value);
        return this;
    }

    public MessageSelection dateLt(int value) {
        addLessThan(MessageColumns.DATE, value);
        return this;
    }

    public MessageSelection dateLtEq(int value) {
